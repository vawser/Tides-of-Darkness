...
NCountry = {
	...
	CORE_HAD_PERMANENT_CLAIM = 0.5,						-- Impacts MODIFIER_CORE_CREATION
	...
	SETTLMENT_GROWTH_CHANCE_MIN = 0.2, -- Minimum chance of increasing development for colonists promoting Settlement Growth
	...
	REVOLUTION_SPREAD_COUNT = 5,			-- Max number of concurrent province revolution spread
	REVOLUTION_DAILY_SPREAD = 0.25,			-- How much the revolution spreads each day (progress is 0-100)
	...
	COHESION_FEDERATION_MEMBER_STRONGER = -0.1,
...
NEconomy = {
	...
	LAND_TECH_MERC_MAINTENANCE_IMPACT = 0.05, 			-- % each tech increases it.
...
NAI = {
	...
	MIN_CAV_PERCENTAGE = 9.0, --AI will always try to have at least this many % of their army as cav, regardless of time in the game.
	MAX_CAV_PERCENTAGE = 40.0, -- For modding, actual ratio is dynamically computed but will be no higher than this.
	...
	DIPLOMATIC_ACTION_GUARANTEE_POWERBALANCE_FACTOR = 30, --AI scoring for guarantee action is increased by this if a nation blocks a powerbalance threat.
	DIPLOMATIC_ACTION_GIFT_POWERBALANCE_FACTOR_AI = 35, --AI willingness to send gifts to AI nations fighting power balance threat is modulated by this.
	DIPLOMATIC_ACTION_GIFT_POWERBALANCE_FACTOR_PLAYER = 30, --AI willingness to send gifts to human nations fighting power balance threat is modulated by this.
	DIPLOMATIC_ACTION_SUBSIDIES_POWERBALANCE_FACTOR = 30, --AI scoring to give subsidies to nations blocking/fighting power balance threat.
	...
	DIPLOMATIC_ACTION_INFLUENCE_NATION_BASE_FACTOR = 5, -- AI base scoring for Influence Nation (needs to be ally or block rival/power balance threat to even apply).
	DIPLOMATIC_ACTION_INFLUENCE_NATION_ALLY_FACTOR = 20, --AI additional scoring for Influence Nation with nations we are allied to.
	...
	AGGRESSIVENESS = 325, -- Base chance (out of 10000) of AI being willing to start a war each diplomatic tick (~1.5 times a month)
	AGGRESSIVENESS_BONUS_EASY_WAR = 900, -- Added to aggressiveness if the war is against a weak or particularly hated enemy
	...
	OVER_FORCELIMIT_AVOIDANCE_FACTOR = 50, -- The higher this number is, the less willing the AI will be to exceed forcelimits
	...
	DIPLOMATIC_ACTION_ALLIANCE_ACCEPTANCE_MULT = 3.15, -- AI scoring for alliance based on willingness to accept it if offered to them
	...
	DIPLOMATIC_ACTION_IMPROVE_RELATIONS_ALLY_FACTOR = 80, -- AI scoring for improve relations is increased by this if they have an attitude with 'ally' desire
	...
	DIPLOMATIC_ACTION_IMPROVE_RELATIONS_VASSALIZE_FACTOR = 200, -- AI scoring for improve relations is increased by this if they have an attitude with 'vassalize' desire (also applied to royal marriage desire)
	...
	DIPLOMATIC_ACTION_MILITARY_ACCESS_EXISTING_RELATION_MULT = 20.0, -- AI scoring for military access is multiplied by this if it has an existing power cost relation
	DIPLOMATIC_ACTION_MILITARY_ACCESS_ENEMY_REGIMENTS_FACTOR = 2.5, -- AI scoring for military access is increased by this for each enemy regiment they are sheltering
	...
	DIPLOMATIC_ACTION_WARNING_WARN_FACTOR = 60, -- AI scoring for warning is changed by this if they have an attitude with the 'warn' desire (multiplied by number of common neighbors )
	...
	DIPLOMATIC_ACTION_FABRICATE_CLAIM_BASE_FACTOR = 80, -- AI scoring for fabricating claims is always increased by this as long as the province is a conquest priority
	DIPLOMATIC_ACTION_FABRICATE_CLAIM_STRATEGY_FACTOR = 1.2, -- AI scoring for fabricating claims based on strategic conquest priorities
	DIPLOMATIC_ACTION_FABRICATE_CLAIM_OTHER_CB_FACTOR = 1.0, -- AI scoring for fabricating claims if they already have another CB usable on the province
	DIPLOMATIC_ACTION_FABRICATE_CLAIM_NOT_ADJACENT_FACTOR = 0.75, -- AI scoring for fabricating claims if the province is not adjacent
	...
	DIPLOMATIC_ACTION_SUBSIDIES_WAR_WITH_RIVAL_FACTOR = 25, -- AI scoring for giving subsidies to a country that is at war with its rival
	...
	DIPLOMATIC_ACTION_SUBSIDIES_INDEBTED_FACTOR = 40, -- AI scoring for giving subsidies to an ally in heavy debt
	...
	AI_TOTAL_DEV_CULTURE_MULTIPLIER = 1.5,				-- Multiplier for how much the AI values having much development in accepted cultures.
	...
	DIPLOMATIC_ACTION_TRIBUTARY_EMPIRE_FACTOR = 7.5,			-- AI scoring for establishing Tributary States is increased by this if actor is Celestial Emperor or has horde government with rank Empire.
	...
	DANGEROUS_ESTATE_INFLUENCE_BUFFER = 6.5,					-- AI will assign estates up to ESTATE_DANGER_THRESHOLD minus this (See ai_territory_modifier)
	...
	ASSIMILATION_INTEREST_AMOUNT_FACTOR = 200.0,					-- Influence on assimilation interest from number of provinces left to conquer
	...
	UPGRADE_CENTER_OF_TRADE_BASE_AI_DESIRE = 75.0,				-- AI scoring for upgrade centers of trade, multiplied by budget/cost
	...
	RECRUIT_ADVISOR_BASE_AI_DESIRE = 80.0,						-- AI scoring for redruiting advisors, multiplied by budget/cost
	PROMOTE_ADVISOR_BASE_AI_DESIRE = 50.0,						-- AI scoring for promoting advisors, multiplied by budget/cost
	DEFENDER_OF_FAITH_BASE_AI_DESIRE = 0.3,						-- AI scoring for becoming defender of faith, multiplied by budget/cost
	CALL_ECUMENICAL_COUNCIL_BASE_AI_DESIRE = 0.0,				-- AI scoring for calling ecumenical council, multiplied by budget/cost
	REPAY_LOAN_BASE_AI_DESIRE = 2000.0,							-- AI scoring for repaying loans, multiplied by (MAX(budget - other loans, 0) * number_of_loans)/cost
	...
	ESTATE_MAX_WANTED_INFLUENCE = 85.0,
	ESTATE_MIN_WANTED_CROWNLAND = 20.0,
...
NAIEconomy = {
	...
	REBEL_THREAT_MILITARIZE_THRESHOLD = 1.0,					-- Above what rebel threat should the AI militarize (i.e. focus spending on armies)
	MILITARY_FOCUS_DEFAULT = 1.6,
	MILITARY_FOCUS_LOWER_BOUND = 1.3,
	MILITARY_FOCUS_UPPER_BOUND = 1.6,
	ARMY_FRACTION_MILITARIZE = 1.5,
	ARMY_FRACTION_PEACEFUL = 1.2,
	ARMY_FRACTION_MILITARIST = 1.4,
	NAVY_FRACTION_PEACEFUL = 1.2,
	NAVY_FRACTION_CAPITALIST = 1.2,
	FORT_FRACTION_MILITARIZE = 3.5,
	FORT_FRACTION_MILITARIST = 6.5,
	FORT_FRACTION_CAPITALIST = 5.0,
	MISSIONARY_FRACTION = 0.175,
	STATE_MAINTENANCE_FRACTION = 0.9,
	BASE_SAVINGS_PRIORITY = 0.5,
	BASE_SAVINGS_PRIORITY_WARTIME = 0.0,
	LOAN_REPAYMENT_SAVINGS_PRIORITY = 1000.0,				-- Per loan
...
NReligion = {
	...
	YEARLY_HARMONY_INCREASE = 3.0,
	HARMONY_LOSS_PER_DEV_CONVERTED = 1.0,
	YEARLY_HARMONY_INCREASE_WHEN_HARMONIZING = -10.0,
	YEARLY_HARMONIZATION_PROGRESS = 0.10, 			-- 3%
	...
	PICK_GOLDEN_BULL_COST = 500,							-- Integer cost for pick a golden bull
...
NNationDesigner = {
	...
	ALL_FEMALE_MALE_CHANCE = 50,				-- Chance for males if starting ruler and heir were both female.
	ALL_MALE_MALE_CHANCE = 50,				-- Chance for females if starting ruler and heir were both male.
	MAX_GOVERNMENT_RANK = 3,
	GOVERNMENT_RANK_COST_1 = -10,
	GOVERNMENT_RANK_COST_2 = 0,
	GOVERNMENT_RANK_COST_3 = 30,

	MANDATE_SUBCONTINENT_NAME = "pandaria_superregion", -- Name of the subcontinent where the Mandate will be given to the biggest nation by development when using random generated nations
},
...
NGovernment = {
	...
	GOVERNMENT_REFORM_COST_INCREASE = 25.0,
	GOVERNMENT_REFORM_YEARLY_BASE_PROGRESS = 25.0,
